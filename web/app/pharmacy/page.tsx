...
export default function PharmacyPage() {
  return (
    <>
      ...
      <section className="max-w-[720px] px-4 pb-8 pt-7 sm:px-7 sm:pt-10">
        <p className="mb-2 text-[11.5px] font-medium tracking-[.08em] text-green">給藥局主</p>
          ...
          {STATS.map((s) => (
            <div key={s.label} className="border-t-2 border-green pt-3">
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="text-[15px] font-black text-ink">{s.unit}</span>
              </div>
      ...
      <section className="border-t border-line bg-surface px-4 py-7 sm:px-7">
      ...
      <section className="px-4 py-7 sm:px-7">
        <div className="max-w-[720px]">
          ...
          <p className="mb-3 text-[13px] leading-[1.8] text-ink-2">
      ...
      <section className="border-t border-line px-4 py-7 sm:px-7">
        <div className="max-w-[720px]">
      ...
      <section className="border-t border-line px-4 py-6 sm:px-7">
        <div className="max-w-[720px] border border-line px-4 py-3.5 text-[13px] leading-[1.7] text-ink-2">
