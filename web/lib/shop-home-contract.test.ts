...
describe("household medicine storefront homepage", () => {
  it("integrates the search into a wall and keeps the full catalog reachable below", () => {
    ...
    expect(productSwipeShowcase).not.toContain('from "next/image"');
    expect(productSwipeShowcase).not.toContain("product-showcase-product");
    expect(productSwipeShowcase).not.toContain("product-showcase-packshot");
    expect(productSwipeShowcase).not.toContain("product-showcase-scene-light");
    expect(productSwipeShowcase).toContain("useState(0)");
    expect(productSwipeShowcase).toContain("sm:mt-2");
    expect(productSwipeShowcase).toContain("h-11 max-w-[164px]");
    expect(productSwipeShowcase).toContain("sm:mt-7");
    expect(productSwipeShowcase).toContain('className="mt-5 sm:mt-1"');
    expect(productSwipeShowcase).toContain("sm:mt-2");
    ...
    expect(globalCss).toContain("/brand/uyao-product-cabinet-composite-v1.webp");
