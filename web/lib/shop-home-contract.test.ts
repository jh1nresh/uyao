...
describe("household medicine storefront homepage", () => {
  it("starts search in the cabinet and continues input in the Agent workspace", () => {
    ...
    expect(productSwipeShowcase).toContain("PRODUCT_SHOWCASE_PLATE");
    expect(productSwipeShowcase).toContain("product-showcase-plate");
    expect(productSwipeShowcase).toContain("product-showcase-packshot");
    expect(productSwipeShowcase).toContain("data-offset={String(offset)}");
    expect(productSwipeShowcase).toContain('sizes="(max-width: 767px) 42vw, 220px"');
    ...
    expect(globalCss).toContain("aspect-ratio: 1774 / 350");
    expect(globalCss).toContain(".product-showcase-plate");
    expect(globalCss).toContain(".product-showcase-packshot");
    expect(globalCss).toContain(".product-showcase-bay");
    expect(globalCss).toContain('.product-showcase-bay[data-offset="0"]');
    expect(globalCss).toContain("transform 420ms var(--ease-brand)");
    expect(globalCss).toContain(".product-showcase-arrow");
    expect(globalCss).toContain("--product-showcase-slot: 22%");
    ...
    expect(productShowcase).toContain("PRODUCT_SHOWCASE_PLATE");
    expect(productShowcase).toContain("/brand/uyao-product-cabinet-reference-v3.webp");
