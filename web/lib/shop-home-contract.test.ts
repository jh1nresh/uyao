...
describe("household medicine storefront homepage", () => {
  it("moves search into the Agent workspace and keeps the full catalog reachable below", () => {
    ...
    expect(productSwipeShowcase).toContain("product-shelf-bays-enter-${motionDirection}");
    expect(productSwipeShowcase).toContain("key={active}");
    ...
    expect(globalCss).toContain("@keyframes product-shelf-pack-enter-next");
    expect(globalCss).toContain("@keyframes product-shelf-pack-enter-prev");
