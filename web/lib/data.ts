...
function partnerProvidedProduct({
  ...
  return {
    ...
    indications: [],
    nutritionFocus,
    nutritionFocusEn: "Partner-provided product composition",
    searchTerms,
    manufacturer,
    origin,
    image,
...
const DRUGS: Drug[] = [
  ...
  partnerProvidedProduct({
    ...
    nutritionFocus: "乳薊果實萃取物所含 Silymarin 的產品組成",
  ...
  // Notion 藥品清單僅提供品名與店家；未附成分、規格或公開產品來源。
  // 對照與待確認項目見 docs/notion-pharmacy-products-2026-09-05.md。
  {
    slug: "deligan",
    updatedOn: "2026-09-05",
    name: "得力干",
