...
const DRUGS: Drug[] = [
  ...
  partnerProvidedProduct({
    ...
    image: {
      ...
      height: 1125,
      kind: "packshot",
      alt: "合作藥局提供的包裝照片：綠杏 LHBcare 益固康 Elgucare 的 72 粒盒裝與 360 粒罐裝並排，盒面標示「全素可食」與 72 Capsules",
  ...
  partnerProvidedProduct({
    ...
    image: {
      ...
      height: 1125,
      kind: "packshot",
      alt: "合作藥局提供的包裝照片：憶元素 天麻100膠囊的金黃色盒裝正面，旁邊是同品項的白色瓶裝",
  ...
  partnerProvidedProduct({
    ...
    image: {
      ...
      height: 1125,
      kind: "packshot",
      alt: "合作藥局提供的包裝照片：PUREGPS 強抗力優 450+ Defense 盒裝正面，標示 60 Capsules 與植物膠囊全素",
