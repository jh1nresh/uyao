...
- uYao CSS gives every role distinct active and inactive Store OS colors while
  preserving the sprout, sapling, flame, and pepper silhouettes.
- All four avatars were constructed in Avatar Lab for uYao. They share one
  expressive eye and motion grammar but use different primary and body-node
  geometry so the roles remain distinct at sidebar size.
